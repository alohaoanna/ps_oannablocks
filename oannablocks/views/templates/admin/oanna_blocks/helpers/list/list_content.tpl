                ...
                {block name="open_td"}
                    ...
                    {if (!isset($params.position) && !$no_link && !isset($params.remove_onclick))}
                        ...
                        {if !isset($tr.noclick)}
                            ...
                            {else}
                                onclick="document.location = '{$current_index|escape:'html':'UTF-8'}&amp;{$identifier|escape:'html':'UTF-8'}={$tr.$identifier|escape:'html':'UTF-8'}&amp;update{$table|escape:'html':'UTF-8'}{if $page > 1}&amp;page={$page|intval}{/if}&amp;token={$token|escape:'html':'UTF-8'}'">
                            {/if}
                        {else}
                            >
                        {/if}
                    ...
                    {if isset($tr.$key)}
                        ...
                        {elseif isset($params.activeVisu)}
                            {if $tr.$key}
                                ...
                                {l s='Enabled' mod='oannablocks'}
                            {else}
                                <i class="icon-remove"></i>
                                {l s='Disabled' mod='oannablocks'}
                            {/if}
                        ...
                        {elseif isset($params.type) && $params.type == 'percent'}
                            {$tr.$key} {l s='%' mod='oannablocks'}
                        {elseif isset($params.type) && $params.type == 'bool'}
                            {if $tr.$key == 1}
                                {l s='Yes' mod='oannablocks'}
                            {elseif $tr.$key == 0 && $tr.$key != ''}
                                {l s='No' mod='oannablocks'}
                            {/if}
    ...
    <tr>
        <td class="list-empty" colspan="{count($fields_display)+1}">
            <div class="list-empty-msg">
                ...
                {l s='No records found' mod='oannablocks'}
            </div>
        </td>
    </tr>
{/if}
